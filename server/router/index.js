...
router.get("/articles/get-all", authMiddleware, ArticleController.getAllArticles);
...
router.post("/article/set-approve-article", authMiddleware, ArticleController.approveArticle);
